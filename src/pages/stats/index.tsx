...
export default function StatsPage() {
  ...
  return (
    <View className="flex flex-col h-full bg-white">
      {/* 自定义导航栏：与胶囊对齐 */}
      <View style={{ position: 'fixed', top: 0, left: 0, right: 0, zIndex: 100, paddingTop: statusBarH, height: capsuleBottom, backgroundColor: '#FFFFFF', display: 'flex', alignItems: 'center', paddingLeft: 12, paddingRight: 12 }}>
        ...
        <Text className="block flex-1 text-center pr-8" style={{ fontSize: 18, fontWeight: '600', fontFamily: '-apple-system, "SF Pro Display", "Helvetica Neue", sans-serif', letterSpacing: 2, color: '#1E293B' }}>支出统计</Text>
      </View>

      <View className="flex-1 px-4 py-3" style={{ paddingTop: capsuleBottom + 8 }}>
